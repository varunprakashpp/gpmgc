<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="projects.aspx.cs" Inherits="news" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <section id="meet-the-team" class="page-section">
            <div class="container"><div class="grid_body">
                    ...
                    <asp:TemplateField>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-md-8">
                                ...
                                <asp:HiddenField ID="hfpt" runat="server" Value='<%# Eval("project_team") %>'></asp:HiddenField>
