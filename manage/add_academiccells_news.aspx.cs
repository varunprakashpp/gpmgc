...
public partial class add_category : System.Web.UI.Page
{
    ...
    static string querry, condition,id,e_id,date,addedby,ip,type,acid;
    protected void Page_Load(object sender, EventArgs e)
    {
        
        try
        {
            if (Request.QueryString["acid"] != null & Request.QueryString["acid"] != null)
            {
                Label lblheading = (Label)Master.FindControl("lblheading");
                lblheading.Text = "Academic cell news";
                ...
                txt_des.config.toolbar = new object[]
			{
				new object[] { "Source", "-"},
                ...
                if (!IsPostBack)
                {
                    if (Request.QueryString["id"] != null & Request.QueryString["type"] != null & Request.QueryString["name"] != null)
                    {
                ...
                Response.Redirect("academiccells.aspx");
        }
        catch (Exception t)
        {
            Response.Write(t);
    ...
    public void assign()
    {
        querry = "select  id,heading,description,photo1,photo2,photo3,display_order,status from tbl_news where flag='" + acid + "' and tag='academiccells' and  id=" + e_id;
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            string photo1 = ds.Tables[0].Rows[0].ItemArray[3].ToString(), photo2 = ds.Tables[0].Rows[0].ItemArray[4].ToString(), photo3 = ds.Tables[0].Rows[0].ItemArray[5].ToString();
            string icon = "../design/dist/img/no_img.jpg";

            if (photo1 != "")
            {
                string path = "../uploads/academiccells/"+acid+"/" + ds.Tables[0].Rows[0].ItemArray[0].ToString() + "/" + photo1;
            ...
            if (photo2 != "")
            {
                string path = "../uploads/academiccells/" + acid + "/" + ds.Tables[0].Rows[0].ItemArray[0].ToString() + "/" + photo2;
                if (File.Exists(Server.MapPath(path)))
                    photo2 = path;
                else
                    photo2 = icon;
            ...
            if (photo3 != "")
            {
                string path = "../uploads/academiccells/" + acid + "/" + ds.Tables[0].Rows[0].ItemArray[0].ToString() + "/" + photo3;
                if (File.Exists(Server.MapPath(path)))
                    photo3 = path;
                else
                    photo3 = icon;
            }
            lbl_img1.Text = "<a href='" + photo1 + "' title='photo1' target='_blank'><img src='"+photo1+"' width='80px'/></a><br/>";
            lbl_img2.Text = "<a href='" + photo2 + "' title='photo1' target='_blank'><img src='" + photo2 + "' width='80px'/></a><br/>";
            lbl_img3.Text = "<a href='" + photo3 + "' title='photo1' target='_blank'><img src='" + photo3 + "' width='80px'/></a><br/>";
        ...
        try
        {
            ...
            if (Request.QueryString["id"] != null & Request.QueryString["type"] != null)
            {
                ...
                if (q > 0)
                {
                    ...
                    Response.Write("<script>alert('Updated successfully');window.location.assign('view_academiccells_news.aspx?acid=" + Request.QueryString["acid"] + "&name=" + Request.QueryString["name"] + "');</script>");
                }
                else
                {
            ...
            else
            {
                ...
                querry = "insert into tbl_news (heading, description,display_order,status,flag,tag,addedby,addedon,addedtype,ip) ";
                ...
                querry += " ,'" + diso + "','1','"+ acid +"','academiccells'";
                ...
                if (q > 0)
                {
                    ...
                    querry = "select max(id) from tbl_news where heading='" + safesql.SafeSqlLiterall(txt_head.Text.Replace("'", "`"), 2) + "' and addedby='" + id + "' and addedtype='admin' and addedon='" + date + "' and flag='" + acid + "' and tag='academiccells' ";
    ...
    private void imagesave(string eid)
    {
        ...
        if (fu_img1.HasFile)
        {
            ...
            string dir_path = Server.MapPath("../uploads/academiccells/" + acid + "/" + e_id + "/");
            if (!System.IO.Directory.Exists(dir_path))
                System.IO.Directory.CreateDirectory(dir_path);

            HttpPostedFile file = fu_img1.PostedFile;
            saveimage("../uploads/academiccells/" + acid + "/" + e_id + "/photo1" + extension, file);
        ...
        if (fu_img2.HasFile)
        {
            ...
            saveimage("../uploads/academiccells/" + acid + "/" + e_id + "/photo2" + extension, file);
        ...
        if (fu_img3.HasFile)
        {
            ...
            saveimage("../uploads/academiccells/" + acid + "/" + e_id + "/photo3" + extension, file);
