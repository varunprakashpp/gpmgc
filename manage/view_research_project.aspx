<%@ Page Title="" Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="view_research_project.aspx.cs" Inherits="view_customers" %>
    ...
    <div class="col-xs-12">
      ...
      <div class="row">
		...
		<div class="box">
            ...
            <div class="box-header"><h3 class="box-title"> Research projects</h3></div>
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="grid1" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Slno">
                        ...
                        <ItemTemplate>
                                    <asp:Label ID="l_file" Text='<%# Eval("project_report") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Project team">
                        <ItemTemplate>
                                    <asp:Label ID="l_team" Text='<%# Eval("project_team") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        </asp:TemplateField>
