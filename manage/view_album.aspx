<%@ Page Title="" Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="view_album.aspx.cs" Inherits="view_customers" %>
    ...
    <div class="col-xs-12">
      ...
      <div class="row">
		...
		<div class="box">
            ...
            <div class="box-header"><h3 class="box-title"> Gallery</h3></div>
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="grid1" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Slno">
                        ...
                        <ItemTemplate>
                                    <asp:Label ID="l_image1" Text='<%# Eval("cover_photo") %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        </asp:TemplateField>
