<%@ Page Title="" Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="add_flashnews.aspx.cs" Inherits="add_category" %>
        ...
        <div class="nav-tabs-custom">
            <div class="tab-content ">
                    ...
                    <div class="col-md-12"><div class="col-md-12">
                        ...
                        <div >
                            <asp:TextBox ID="txt_des" class="form-control pull-right " Rows="4" runat="server" TextMode="MultiLine" Width="100%"></asp:TextBox>
                        </div>
                        </div>
                    </div></div>
