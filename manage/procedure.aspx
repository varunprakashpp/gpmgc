<%@ Page Title="" Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="procedure.aspx.cs" Inherits="add_category" %>
            ...
            <div class="tab-content ">
                    ...
                    <div class="col-md-12"  >
                        ...
                        <div class="col-md-12">
                            ...
                            <label><br />Procedure : <span style="color: red;">*</span></label>
                            <div >
