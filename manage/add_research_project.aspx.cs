...
public partial class add_category : System.Web.UI.Page
{
    ...
    static string querry, condition, id, e_id, date, addedby, ip, type, photo1, photo2, photo3, rpt;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            lblheading.Text = "Research project";
    ...
    public void lockall()
    {
        ...
        txt_team.Attributes.Add("readonly", "readonly");
    ...
    public void assign()
    {
        querry = "select  id,heading,description,photo1,photo2,photo3,display_order,status,project_team,project_report from tbl_projects where flag='research' and  id=" + e_id ;
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            txt_team.Text = EncodeDecode.base64Decode( ds.Tables[0].Rows[0].ItemArray[8].ToString());
            ...
            rpt = ds.Tables[0].Rows[0].ItemArray[9].ToString();
            string rptpath = "../design/dist/img/no_img.jpg";
            string icon = "../design/dist/img/no_img.jpg";

            if (photo1 != "")
            {
                string path = "../uploads/research/" + ds.Tables[0].Rows[0].ItemArray[0].ToString() + "/" + photo1;
            ...
            if (photo2 != "")
            {
                string path = "../uploads/research/" + ds.Tables[0].Rows[0].ItemArray[0].ToString() + "/" + photo2;
                if (File.Exists(Server.MapPath(path)))
                {
                    photo2 = path;
            ...
            if (photo3 != "")
            {
                string path = "../uploads/research/" + ds.Tables[0].Rows[0].ItemArray[0].ToString() + "/" + photo3;
                if (File.Exists(Server.MapPath(path)))
                {
                    photo3 = path;
            ...
            if (rpt != "")
            {
                string path = "../uploads/research/" + ds.Tables[0].Rows[0].ItemArray[0].ToString() + "/" + rpt;
                if (File.Exists(Server.MapPath(path)))
                {
                    if (rpt.Split('.').Last() == "pdf")
                        rptpath = "../design/dist/img/file/pdf.png";
                    else if (path.Split('.').Last() == "doc" || path.Split('.').Last() == "docx")
                        rptpath = "../design/dist/img/file/doc.png";
                    else if (path.Split('.').Last() == "rar")
                        rptpath = "../design/dist/img/file/rar.png";
                    else if (path.Split('.').Last() == "zip")
                        rptpath = "../design/dist/img/file/zip.png";
                    else
                        rptpath = "../design/dist/img/file/no_img.png";
                    
                    rpt = path;
                    lbl_rpt.Text = "<a href='" + rpt + "' title='Report' target='_blank'><img src='" + rptpath + "' width='80px'/></a>";
    ...
    {
        querry = " UPDATE tbl_projects SET photo1=''  where flag='research' and  id=" + e_id;
        int c = cc.Insert(querry);
        if (c > 0)
        {
            File.Delete(Server.MapPath(photo1));
            Response.Write("<script>alert('Deleted successfully');window.location.assign('add_research_project.aspx?id=" + Request.QueryString["id"] + "&type=edit');</script>");
        }
    }

    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        querry = " UPDATE tbl_projects SET photo2='' where flag='research' and  id=" + e_id;
        int c = cc.Insert(querry);
        if (c > 0)
        {
    ...
    {
        querry = " UPDATE tbl_projects SET photo3='' where flag='research' and  id=" + e_id;
        int c = cc.Insert(querry);
        if (c > 0)
        {
    ...
    {
        querry = " UPDATE tbl_projects SET project_report='' where flag='research' and  id=" + e_id;
        int c = cc.Insert(querry);
        if (c > 0)
        {
            File.Delete(Server.MapPath(rpt));
            Response.Write("<script>alert('Deleted successfully');window.location.assign('add_research_project.aspx?id=" + Request.QueryString["id"] + "&type=edit');</script>");
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                querry = "update tbl_projects set ";
                ...
                querry += ",project_team='" + EncodeDecode.base64Encode(safesql.SafeSqlLiterall(txt_team.Text.Replace("'", "`"), 2)) + "'";
                ...
                if (q > 0)
                {
                    ...
                    Response.Write("<script>alert('Updated successfully');window.location.assign('view_research_project.aspx');</script>");
                }
                else
                {
            ...
            else
            {
                ...
                querry = "insert into tbl_projects (heading, description,display_order,status,flag,project_team,addedby,addedon,addedtype,ip) ";
                ...
                querry += " ,'" + diso + "','1','research','" + EncodeDecode.base64Encode(safesql.SafeSqlLiterall(txt_team.Text.Replace("'", "`"), 2)) + "'";
                ...
                if (q > 0)
                {
                    ...
                    querry = "select max(id) from tbl_projects where heading='" + safesql.SafeSqlLiterall(txt_head.Text.Replace("'", "`"), 2) + "' and description='" + EncodeDecode.base64Encode(safesql.SafeSqlLiterall(txt_des.Text.Replace("'", "`"), 2)) + "' and addedby='" + id + "' and addedtype='admin' and addedon='" + date + "' and flag='research' ";
    ...
    private void imagesave(string eid)
    {
        ...
        if (fu_img2.HasFile)
        {
            ...
            saveimage("../uploads/research/" + e_id + "/photo2" + extension, file);
        ...
        if (fu_img3.HasFile)
        {
            ...
            saveimage("../uploads/research/" + e_id + "/photo3" + extension, file);
        ...
        if (image != "")
        {
            ...
            querry = " UPDATE tbl_projects SET "+image+" WHERE id="+eid;
            int c = cc.Insert(querry);
        }
    }
    ...
    private void rptsave(string eid)
    {
        if (fu_rpt.HasFile)
        {
            string extension = System.IO.Path.GetExtension(fu_rpt.FileName);
            string dir_path = Server.MapPath("../uploads/research/" + e_id + "/");
            if (!System.IO.Directory.Exists(dir_path))
                System.IO.Directory.CreateDirectory(dir_path);

            fu_rpt.SaveAs(Server.MapPath("../uploads/research/" + e_id + "/Report" + extension));

            querry = " UPDATE tbl_projects SET project_report='Report" + extension + "' WHERE id="+eid;
            int c = cc.Insert(querry);
        }
    }
