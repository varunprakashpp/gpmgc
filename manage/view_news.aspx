<%@ Page Title="" Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="view_news.aspx.cs" Inherits="view_customers" %>
    ...
    <div class="col-xs-12">
      ...
      <div class="row">
		...
		<div class="box">
            ...
            <div class="box-header"><h3 class="box-title"> News</h3></div>
