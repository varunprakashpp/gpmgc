<%@ Page Title="" Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="view_academiccells_news.aspx.cs" Inherits="view_customers" %>
    ...
    <div class="col-xs-12">
      ...
      <div class="row">
		...
		<div class="box">
            ...
            <div class="box-header"><h3 class="box-title"><asp:Label ID="lblacname" runat="server" Text=""></asp:Label> Academic cell news</h3></div>
